    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form">
                    <div class="form-group">
                        <label for="recipient-name" class="control-label"><?=tl("Old password")?>:</label>
                        ...
                        <?php 
                           ...
                           // print_r($cfgpasswd);
                            ...
                            $cfglang = $language[0]['lang'];
                        ?>
                        <input type="password" value="<?php echo $cfgpasswd; ?>" class="form-control" id="oldpasswdvalue_conf" style="display: none">
                        <input type="text" value="<?php echo $cfglang; ?>" class="form-control" id="current_language" style="display: none">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="control-label"><?=tl("New password")?>:</label>
                        <input type="password" class="form-control" id="changepasswdvalue">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="control-label"><?=tl("Confirm password")?>:</label>
...
<div id="prompt-message-input-null" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Message Window</h4>
            </div>
            <div class="modal-body">

                <h4 id="js--prompt-text" >
                    <?=tl("Input null")?>
                </h4>
