...
$language = array(
    ...
    // Topmenu
    "staking-status"                                                        => "収益情報",
    "wallet-status"                                                         => "ウォレットステータス",
    "connections"                                                           => "ノード",
    "settings"                                                              => "Settings",
    "logout"                                                                => "Logout",

    // Menu
    "staking-info"                                                          => "ステーキングインフォメーション",
    "transactions"                                                          => "取引",
    "send"                                                                  => "Send",
    "receive"                                                               => "Receive",
    "wallet-info"                                                           => "ウォレット情報",
    ...
    "unlock-wallet-for-staking"                                             => "ウォレットをアンロックして収益を受け取る",
    "unlock-for-staking"                                                    => "ウォレットをアンロックして収益を受け取る",
    ...
    "last-updated"                                                          => "最新更新",
    "revenue"                                                               => "収入",
    "bittrex---btc-price"                                                   => "Bittrex - BTC 価格",
    "blocks"                                                                => "ブロック",
    "total-blocks-since"                                                    => "総ブロック数",
    "balance"                                                               => "バランス",
    "recent-transactions"                                                   => "最近の取引",
    "view-your-recent-transactions-below"                                   => "以下の最新取引記録を確認する",
    "date"                                                                  => "日時",
    "account"                                                               => "アカウント",
    "amount"                                                                => "数量",
    "confirmations"                                                         => "確認する",
    ...
    // Staking Info
    "network-stake-weight"                                                  => "ステーキングウェート",
    "your-weight"                                                           => "あなたのステーキングウェート",
    "network-weight-based-on-the-amount-of-coins"                           => "XWCに基づくステーキングウェート",
    "expected-stake"                                                        => "予想されるステーキングウェート",
    "latest-stake"                                                          => "最新収益",
    "reserved-coins-unable-to-spend"                                        => "Reserved coins unable to spend",
    "stake-calculator"                                                      => "収益計算器",
    "calcultated-from-current"                                              => "現在の全ネット上のステーキングウェートを１年平均で計算すると、収益パーセンテージ",
    "staking-coins"                                                         => "現在収益を受け取っているコイン",
    "compound-interest"                                                     => "複利",
    "xwc"                                                                   => "XWC",
    "recent-stakes"                                                         => "最終の収益",
    "view-your-recent-stakes-below"                                         => "v最終の収益を見る",
    "wallet-not-staking"                                                    => "not staking",                                   // untranslated
    "password-cannot-be-empty"                                              => "password cannot be empty",                      // untranslated

    // Connections
    "current-wallet-connections"                                            => "現在のウォレットの接続数",
    "address"                                                               => "アドレス",
    "version"                                                               => "バージョン",
    "subversion"                                                            => "サブバージョン",
    "inbound"                                                               => "接続数を入力する",
